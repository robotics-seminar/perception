...
try:
    from .kinect2_sensor import Kinect2PacketPipelineMode, Kinect2FrameMode, Kinect2RegistrationMode, Kinect2DepthMode, Kinect2BridgedQuality, Kinect2Sensor, KinectSensorBridged, GazeboKinectSensorBridged, VirtualKinect2Sensor, Kinect2SensorFactory, load_images
except Exception:
...
__all__ = [
    ...
    'Kinect2PacketPipelineMode', 'Kinect2FrameMode', 'Kinect2RegistrationMode', 'Kinect2DepthMode', 'Kinect2BridgedQuality', 'Kinect2Sensor','KinectSensorBridged','GazeboKinectSensorBridged','VirtualKinect2Sensor', 'Kinect2SensorFactory', 'load_images',
    'EnsensoSensor',
